		...
		for g in g_values:
			for p in p_values:
				...
				for h in h_values:			
					...
					print "g: "+str(g)+", h: "+str(h)+", p: "+str(p)+", x: "+str(result[0])+", notprimroot: "+str(count_notprimroot)+", no_solns: "+str(count_nosolns)+", largerprimelist: "+str(count_needlargerprimelist)				
