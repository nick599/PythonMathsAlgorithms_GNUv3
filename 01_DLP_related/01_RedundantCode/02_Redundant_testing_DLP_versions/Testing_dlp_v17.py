	...
	for number in xrange(0,len(x)):
		...
		if b <> 1:
			if not cong_x:
				...
				M = b			
				#cong.append(1)
				#print "cong_x is: "+str(cong_x)
				#print "cong_moduli is: "+str(cong_moduli)
			else:	
				#print "cong_x is: "+str(cong_x)
				#print "cong_moduli is: "+str(cong_moduli)			
			
				#print "number-1 is: "+str(number-1)
				...
				#print "Subtracting cong_x[-1] from current x["+str(number)+"].."
				#print "Subtracting cong_x["+str(number-1)+"] from current x["+str(number)+"].."
				c = x[number] - cong_x[-1]
				#c = x[number] - cong_x[number-1]
				#print "c now is: "+str(c)
			
				#print "cong_moduli["+str(number-1)+"] to use in inverse is: "+str(cong_moduli[number-1]) 	#number=
			...
			#print "Congruence skipped due to moduli = 1"
			#skip = True
