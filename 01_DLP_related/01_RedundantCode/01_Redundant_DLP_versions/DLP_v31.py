...
def prop_234(Bi, zi, qi, ei, p):
	...
	result = calc_xi(q_powers, g, h, qi, ei, p, xi)
	xi_calc = result[0]
	print "xi_calc are: "+str(xi_calc)
...
def calc_xi(q_powers, g, h, qi, ei, p, xi):
	cumul_q_powers=[]
	cumul_xi_q_powers=[]
	for q_power in q_powers:
		if q_power==1:
