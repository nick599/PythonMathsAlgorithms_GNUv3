...
def test(g_values, p_values, primes, sample_range, output_path):
	...
	for g in g_values:
		...
		for p in p_values:
			...
			txt_to_append = "concat_g_p: "+g_p_time_values[0]+", mean_time: "+g_p_time_values[1]+", max_time: "+g_p_time_values[2]+", min_time:  "+g_p_time_values[3]+"\n"
