...
def main():
	...
	for num in range(1,11):	
		...
		time = round(test(g_values, p_values, primes),3)
		#time = test(g_values, p_values, primes)
		print("Time taken in mins for total combinations:",time[1],"is",time[0])
		#return c_after_loops_mins, Grand_total_values
		time_values.append(time[0])
		total_combinations.append(time[1])

	for time_value in time_values:	
		index = time_values.index(time_value)
		print("time_value[",index,"]:",time_value,", total_combinations[",index,"]:",total_combinations[index])
		#value = total_combinations[index]
