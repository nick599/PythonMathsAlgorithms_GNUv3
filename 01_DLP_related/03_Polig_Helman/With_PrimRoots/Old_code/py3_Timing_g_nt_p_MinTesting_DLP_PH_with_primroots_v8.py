	...
	for g in g_values:
		...
		for p in p_values:
			...
			if c_after_prim_root_count == 0:
				...
				mean_prim_root_time = str(round(float(c_after_prim_root_total)/c_after_prim_root_count,8))
			...
			txt_to_append = "concat_g_p: "+concat_g_p+", mean_time: "+mean_time+", max_time: "+max_time+", min_time:  "+min_time+", mean_prim_root_time: "+mean_prim_root_time+", mean_polig_time: "+mean_polig_time+"\n"
