...
def main():
	...
	output_filename = "output_hi_values_v"+str(version)+".txt"
					...
					if result is False:
						...
						for h in range(1, p):								
							...
							if h in G_list:
								...
								c_h_value = time.time() - s_before_h_value
								txt_to_append = "Concat_g_p_h: "+str(concat_g_p_h)+", time: "+str(c_h_value)+", h_values: "+str(hi)+"\n"
								...
								h_time_values.append(c_h_value)
