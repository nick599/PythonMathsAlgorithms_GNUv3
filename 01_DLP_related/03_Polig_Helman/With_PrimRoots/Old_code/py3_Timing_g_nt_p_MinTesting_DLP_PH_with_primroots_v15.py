				...
				if g != p:				
					...
					if result is False:
						...
						if mean_h_values_individ_all >= 0.003:
							...
							txt_to_append = "g:"+str(g)+", p:"+str(p)+", len_G_list:"+str(len_G_list)+", max_h_values:" +str(round(max_h_values_individ_all,6))+", h_value_max:"+str(h_value_max)+", mean_h_values:"+str(round(mean_h_values_individ_all,6))+", h_power_values:"+str(h_power_values_to_append)+", gi_values:"+str(gi_values_to_append)+"\n"
							txtfile_append(txt_to_append,output_path)
