...
def test(g_values, p_values, primes, sample_range, output_path):
	...
	for g in g_values:
		...
		for p in p_values:
			...
			max_h_values_time = str(round(max(h_time_values),8))
			#print("max_time is:",max_time)
			
			min_h_values_time = str(round(min(h_time_values),8))
			#print("min_time is:",min_time)
			...
			txt_to_append = "concat_g_p: "+concat_g_p+", mean_time: "+mean_time+", max_time: "+max_time+", min_time:"+min_time+",_ mean_all_h_values_time: "+mean_all_h_values_time+", mean_individ_h_values_time: "+mean_individ_h_values_time+", max_individ_h_values_time: "+max_h_values_time+", min_individ_h_values_time:"+min_individ_h_values_time+"\n"
