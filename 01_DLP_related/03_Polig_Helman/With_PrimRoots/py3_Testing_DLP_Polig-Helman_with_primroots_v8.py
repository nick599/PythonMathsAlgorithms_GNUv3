...
def main():
	...
	total_p_values = total_g_values * len(p_values)
	...
	c_after_loops_minutes = float(c_after_loops) / 60

	print("Grand total combinations considered:",Grand_total_values,", total_g_values:",total_g_values,", total_p_values:",total_p_values,", total_h_values:",total_h_values,", number_no_solns:",count_nosolns,", largerprimelist:",count_needlargerprimelist,", count_x_status_false:",count_x_status_false, "time_minutes:",c_after_loops_minutes)
