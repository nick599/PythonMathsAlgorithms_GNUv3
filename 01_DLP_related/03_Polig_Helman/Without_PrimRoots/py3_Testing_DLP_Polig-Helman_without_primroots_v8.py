...
def main():
	...
	for g in g_values:
		...
		for p in p_values:
			...
			if p_position > 0 and p_position % 50 == 0:
	...
	print("Grand total combinations considered: ",Grand_total_values,", total_g_values: ",total_g_values,", total_p_values: ",total_p_values,", total_h_values: ",total_h_values,", number_no_solns: ",count_nosolns,", largerprimelist: ",count_needlargerprimelist,", count_ph_nosoln_x_status_false: ",count_x_status_false)
