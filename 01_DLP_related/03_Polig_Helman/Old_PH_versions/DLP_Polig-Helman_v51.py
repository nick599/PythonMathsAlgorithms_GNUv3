...
def dlp(g, h, p, primefile, count_nosolns, count_zi_bi_equal_1, count_bi_equal_1_zi_ntequal_0_1, count_x_equals_0, count_Bi_equals_zi, count_normal_soln, count_needlargerprimelist, answers_to_be_checked):	
	...
	if result is False:
		...
		result_polig = polig_helman(primes_list, powers, g, h, p, count_nosolns, count_zi_bi_equal_1, count_diffeq0, count_x_equals_0, count_bi_equal_1_zi_ntequal_0_1)
		...
		print "x's are: "+str(x)
		print "x_moduli_final are: "+str(x_moduli_final)
...
def polig_helman(primes_list, powers, g, h, p, count_nosolns, count_zi_bi_equal_1, count_diffeq0, count_x_equals_0, count_bi_equal_1_zi_ntequal_0_1):
		...
		if Bi[i]==0 and zi[i]==1:
			...
			if status == False:
				...
				while ei >= 1:
					...
					if status == True:
						print "Moduli found: "+str(qi[i]**ei)
						break
					ei = ei - 1
