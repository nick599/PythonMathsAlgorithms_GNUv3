...
def polig_helman(primes_list, powers, g, h, p, count_nosolns, count_zi_bi_equal_1, count_diffeq0, count_x_equals_0, count_bi_equal_1_zi_ntequal_0_1, count_normal_soln, count_Bi_equals_zi):
	...
	print "Running polig-helman ("+str(primes_list)+", "+str(powers)+", "+str(g)+", "+str(h)+", "+str(p)+", count_nosolns, count_zi_bi_equal_1, count_diffeq0, count_x_equals_0, count_bi_equal_1_zi_ntequal_0_1, count_normal_soln, count_Bi_equals_zi)"	
	...
	for C in C_list:
		...
		if status == False:
			...
			#diff = a_exp_x_eq_r(Bi[i], init_moduli, zi[i]) #a_exp_x_eq_r(g, p, r):
			#if diff==0:
