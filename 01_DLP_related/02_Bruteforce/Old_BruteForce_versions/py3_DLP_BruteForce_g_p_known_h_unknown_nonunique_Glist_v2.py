...
def main():
	...
	for num in range(0,p):
		...
		if num > 0 and num % 100000 == 0:
			print("number is:",num)
		G_list.append(pow(g,num,p))
		temp_G = pow(g,num,p)
		x_list.append(num)
		temp_x = num
		G_x_list_temp.append(temp_G)
		G_x_list_temp.append(temp_x)
		G_x_list.append(G_x_list_temp)
		#a = pow(g,num,p)
		#print("a is:",a)
	...
	len_G_x_list = len(G_x_list)

	print("len_G_list:",len_G_list)
	print("len_x_list:",len_x_list)
	print("len_G_x_list:",len_x_list)
	...
	if not x_soln_list:
		...
		print("x_soln_list:",x_soln_list)
		print("h_soln_list:",h_soln_list)
