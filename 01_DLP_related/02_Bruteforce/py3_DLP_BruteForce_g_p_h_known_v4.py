...
def main():
	...
	print('Checking if a solution for x exists..')
	...
	if h not in G_list:
		...
		#sys.exit()
		result_dlp = dlp(g,h,p, primefile, count_nosolns, count_needlargerprimelist, answers_to_be_checked, count_brute_force_soln)
...
def dlp(g, h, p, primefile, count_nosolns, count_needlargerprimelist, answers_to_be_checked, count_brute_force_soln):
