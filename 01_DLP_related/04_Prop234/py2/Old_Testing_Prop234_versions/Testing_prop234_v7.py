					...
					for h in h_values:								
						if h >= p:
							...
							if exponent_g_n_status == True:
								...
								#print('Running dlp()..')
								result = dlp(g,h,p, primefile, count_nosolns, count_x_equals_0, count_normal_soln, count_needlargerprimelist, answers_to_be_checked, count_q_e_found, count_q_e_not_found, count_order_not_prime, count_calc_xi_no_solns, count_notprime, count_primroot, prim_root_list, not_prim_root_list)
...
def dlp(g, h, p, primefile, count_nosolns, count_x_equals_0, count_normal_soln, count_needlargerprimelist, answers_to_be_checked, count_q_e_found, count_q_e_not_found, count_order_not_prime, count_calc_xi_no_solns, count_a_notprime, count_primroot, prim_root_list, not_prim_root_list):
