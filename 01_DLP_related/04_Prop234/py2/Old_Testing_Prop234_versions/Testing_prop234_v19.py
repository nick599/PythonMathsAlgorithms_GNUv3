				...
				if g == p:
					...
					for h in h_values:								
						...
						#Now check if concat_g_h is order_false_list
							...
							x_final = "No solns!"			
							print x_final, count_nosolns, count_order_not_prime, count_calc_xi_no_solns, count_normal_soln, 0, answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_q_e_found, count_q_e_not_found, count_a_notprime, order_false_list
							...
							if order_status == True:
								...
								result = dlp(g, p, h, count_nosolns, count_x_equals_0, count_normal_soln, count_needlargerprimelist, answers_to_be_checked, count_order_not_prime, count_calc_xi_no_solns, count_notprime, order_false_list, primes, q, e)
...
def dlp(g, p, h, count_nosolns, count_x_equals_0, count_normal_soln, count_needlargerprimelist, answers_to_be_checked, count_order_not_prime, count_calc_xi_no_solns, count_notprime, order_false_list, primes, q, e):
