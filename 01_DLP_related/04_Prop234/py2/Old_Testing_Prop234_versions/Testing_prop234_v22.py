...
#def calc_order(g, p, count_nosolns, count_order_not_prime, count_q_e_found, count_q_e_not_found, order_false_list, primes):
	...
	if order == 1:						#O(1)
		...
		q = 0
		e = 0
		return count_nosolns, count_order_not_prime, count_q_e_found, count_q_e_not_found, order_false_list, q, e, order_status, n_prime, counts_added, count_order_prime
		...
		print "*** Possibly double counting here - order_status is not checked here - but is checked in other conditions??? ***"
		return count_nosolns, count_order_not_prime, count_q_e_found, count_q_e_not_found, order_false_list, q, e, order_status, n_prime, counts_added, count_order_prime
