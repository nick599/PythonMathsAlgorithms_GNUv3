					...
					for h in h_values:								
						...
						if h >= p:
							...
							if status == True:
								...
								#return (0 or x[0]), count_nosolns, count_primroot, count_order_not_prime, count_calc_xi_no_solns, count_normal_soln, count_normal_soln, (0 or x_moduli[0]), count_q_e_not_found, answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_q_e_found, count_q_e_not_found

								#Variables needed in return:
								#x_final
								#count_nosolns
								#count_x_equals_0							
								#count_needlargerprimelist
								#answers_to_be_checked
								#count_q_e_found
								#count_q_e_not_found
								...
								answers_to_be_checked.append(result[9])
								count_x_equals_0 = count_order_not_prime + result[10]
								count_needlargerprimelist = count_needlargerprimelist + result[11]
								count_q_e_found = count_q_e_found + result[12]
								count_q_e_not_found = count_q_e_not_found + result[13]		
								count_calc_xi_no_solns =.......
								count_notprime =.......
							...
							x_moduli_final = result[7]
							answers_to_be_checked.append(result[9])
							count_x_equals_0 = count_x_equals_0 + result[10]
							count_needlargerprimelist = count_needlargerprimelist + result[11]
							count_q_e_found = count_q_e_found + result[12]
							count_q_e_not_found = count_q_e_not_found + result[13]
		...
		if sqrt_p > largest_prime:				#O(1)	#Subtotal: O(4)
			...
			if result is False:
				...
				if calc_xi_status == True:
					...
					return x[0], count_nosolns, count_primroot, count_order_not_prime, count_calc_xi_no_solns, count_normal_soln, count_normal_soln, x_moduli[0], count_q_e_not_found, answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_q_e_found, count_q_e_not_found
					...
					return 0, count_nosolns, count_primroot, count_order_not_prime, count_calc_xi_no_solns, count_normal_soln, count_normal_soln, 0, count_q_e_not_found, answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_q_e_found, count_q_e_not_found
