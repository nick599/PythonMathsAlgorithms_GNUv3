	...
	while error==False:	
		for g in g_values:
			...
			for p in p_values:
				...
				if g == p:
					#print "count_nosolns before: "+str(count_nosolns)
					count_nosolns = count_nosolns + len(h_values)
					#print "count_nosolns after: "+str(count_nosolns)			
					...
					for h in h_values:								
						...
						if h >= p:
							...
							if order_status == True:
								...
								result = dlp(g, p, h, count_nosolns, count_x_equals_0, count_normal_soln, count_needlargerprimelist, answers_to_be_checked, count_calc_xi_no_solns, count_notprime, order_false_list, primes, q, e, n_prime, count_xi_not_found, count_calc_xi_status_false)
								...
								#return x[0], count_nosolns, count_calc_xi_no_solns, count_normal_soln, 0, answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_notprime, order_false_list, count_xi_not_found, count_calc_xi_status_false
...
def dlp(g, p, h, count_nosolns, count_x_equals_0, count_normal_soln, count_needlargerprimelist, answers_to_be_checked, count_calc_xi_no_solns, count_notprime, order_false_list, primes, q, e, n_prime):
	...
	if status_isprime_a == False:					#O(1)
		...
		if sqrt_p > largest_prime:				#O(1)	#Subtotal: O(4)
			...
			result_prop_234 = prop_234(g, h, q, e, p, count_xi_not_found, count_calc_xi_status_false)
			...
			if calc_xi_status == True and xi_found == True:
				...
				if x[0] == 0:		
					...
					return x[0], count_nosolns, count_calc_xi_no_solns, count_normal_soln, x_moduli[0], answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_notprime, order_false_list, count_xi_not_found, count_calc_xi_status_false
				...
				return x[0], count_nosolns, count_calc_xi_no_solns, count_normal_soln, 0, answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_notprime, order_false_list
...
def prop_234(g, h, qi, ei, p, count_xi_not_found, count_calc_xi_status_false):
	#print "-----------------------------------"
