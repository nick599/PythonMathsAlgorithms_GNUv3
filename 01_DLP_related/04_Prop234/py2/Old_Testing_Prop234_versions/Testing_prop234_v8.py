	...
	if status_isprime_a == False:					#O(1)
		...
		if sqrt_p > largest_prime:				#O(1)	#Subtotal: O(4)
			...
			if concat in prim_root_list:
				...
				x_final = "No solns!"			
				return x_final, count_nosolns, count_primroot, count_order_not_prime, count_calc_xi_no_solns, count_normal_soln, 0, answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_q_e_found, count_q_e_not_found, count_a_notprime, prim_root_list, not_prim_root_list
				...
				if prim_root_status is False:
					...
					if concat in order_false_list:
						print "Order for "+str(concat)+" previously calculated as False!"	
					...
					if order == 1:						#O(1)
						...
						if order_status==False:						#O(1)
							...
							if calc_xi_status == True:
								...
								return x[0], count_nosolns, count_primroot, count_order_not_prime, count_calc_xi_no_solns, count_normal_soln, x_moduli[0], answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_q_e_found, count_q_e_not_found, count_a_notprime, prim_root_list
								...
								return 0, count_nosolns, count_primroot, count_order_not_prime, count_calc_xi_no_solns, count_normal_soln, 0, answers_to_be_checked, count_x_equals_0, count_needlargerprimelist, count_q_e_found, count_q_e_not_found, count_a_notprime, prim_root_list
