...
print("Version:",version,". 29/09/2018.")
...
def main():
	...
	for number in sample_range:
		...
		print("output_path for summary result:",output_path)
		data="number:"+str(number)+", len p_q_list:"+str(len(n_p_q_list))+", c_after_loop:"+str(c_after_loop)+"\n"
