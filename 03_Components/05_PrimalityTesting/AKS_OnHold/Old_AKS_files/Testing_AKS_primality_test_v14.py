...
def x_plus_a_cong_check(n, r, int_floor_sqrt_eulerphi_r_times_log_2_n):
	...
	for b in xrange(0, n + 1):	
		result = Bin_Coeff(n)
		#print "Bin_Coeff("+str(n)+") is: "+str(result)
...
def Bin_Coeff(n):
	...
	for b in xrange(0, n + 1):	
		#print "Running Bin_Coeff("+str(n)+", "+str(b)+").."	
		if (n == b) or (b == 0):
			#print "Bin_Coeff("+str(n)+", "+str(b)+") is 1"
			return 1
		elif (b == 1) or b == n - 1:
			#print "Bin_Coeff("+str(n)+", "+str(b)+") is "+str(n)
			return n
		else:
			n_fac = factorial(n)
			...
			#print "n_minus_b_fac is: "+str(n_minus_b_fac)
			#print "Bin_Coeff("+str(n)+", "+str(b)+") is "+str(result)
			#raw_input("waiting for user..")
			return result
