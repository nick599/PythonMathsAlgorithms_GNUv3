				...
				if a == 0:
					...
					if n > r:
						...
						if ep_status == False:
							...
							#now want to find an a s.t. gcd(n,a)=1							
							#a = 0
							#for a_value in xrange(2, n):							
							#	g, x, y = egcd(n, a_value)
							#	if g == 1:
							#		a = a_value
							#		break		
							#print "a is: "+str(a)
...
def factorial(z):
	...
	if z == 1:
		...
		for b in xrange(z + 1, 1, -1):
			print "b is now: "+str(b)			
			answer = answer * b
			print str(answer)+" is now: "+str(answer)
...
def x_plus_a_cong_check(n, r, int_floor_sqrt_eulerphi_r_times_log_2_n):
	...
	#Step 2 - take away (x**n + a) from result1 of expanded binomial and store result (result2), and print it.





	#step 3 - take result2 mod(x**r-1, n), store it (result3), and print it.
