...
def pollards_rho_factorise(n, seed, factors, factoring_times, stage):		
	...
	if d == n:
		#print(d,"=",n)
		return n, d, "Failure", factoring_times		
	else:
		return n, d, factors, factoring_times	
	...
	#			#input("Waiting for user..")
			#else:
				#result1 = pollards_rho_factorise(n, seed, factors, factoring_times,stage)
				#return n, factors, factoring_times
				#n = result1[0]
				#factors = result1[1]
				#factoring_times = result1[2]
	...
	#		print("n is now:",n)
			#print("type(n):",type(n))
			#result2 = pollards_rho_factorise(n, seed, factors, factoring_times,stage)
			#return n, factors, factoring_times
			#n = result2[0]
			#factors = result2[1]
			#factoring_times = result2[2]
	#else:
	#	stage="Three-a"
	#	print("stage:",stage)
	...
	#	print("n is now:",n)
		...
		#print("stage:",stage)
		#seed = 2
			#result3 = pollards_rho_factorise(n, seed, factors, factoring_times,stage)
			#return n, factors, factoring_times
			#n = result3[0]
			#factors = result3[1]
			#factoring_times = result3[2]			
