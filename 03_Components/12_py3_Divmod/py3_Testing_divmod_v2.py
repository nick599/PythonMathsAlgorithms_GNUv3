...
def main():
	...
	for x in sample_range:	
		result = divmod_testing(test_range_hundred,p_values_hundred)
	...
	print("mean_tot_time_hundred_divmod:",mean_tot_time)
	print("max_tot_time_hundred_divmod:",max_tot_time)
	print("min_tot_time_hundred_divmod:",min_tot_time)
	...
	for x in sample_range:	
		result = divmod_testing(test_range_thousand,p_values_thousand)
		#return c_divmod_tot_time
		tot_time = tot_time + result
		time_values.append(result) 
	...
	mean_tot_time = tot_time / len_test_range 
	mean_tot_time = round(mean_tot_time,4)
	print("mean_tot_time_thousand_divmod:",mean_tot_time)
	print("max_tot_time_thousand_divmod:",max_tot_time)
	print("min_tot_time_thousand_divmod:",min_tot_time)
	...
	for x in sample_range:	
		if x % 5 == 0:
			print("Test:",x)
		result = divmod_testing(test_range_fivethousand,p_values_fivethousand)
		#return c_divmod_tot_time
		tot_time = tot_time + result
		time_values.append(result) 
	...
	mean_tot_time = tot_time / len_test_range 
	mean_tot_time = round(mean_tot_time,4)
	print("mean_tot_time_fivethousand_divmod:",mean_tot_time)
	print("max_tot_time_fivethousand_divmod:",max_tot_time)
	print("min_tot_time_fivethousand_divmod:",min_tot_time)
