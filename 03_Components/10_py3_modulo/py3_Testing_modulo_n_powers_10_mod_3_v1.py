...
def main():
	...
	#sample_range = [10**2,10**3,10**4,10**5,10**6,10**9,10**12,10**15,10**20,10**50,10**100]
	sample_range = range(1,21)
	test_range = [10**2,10**3,10**4,10**5,10**6,10**9,10**12,10**15,10**20,10**50,10**100]
	...
	for x in test_range:	
		result = modulo_testing(x,test_num)
	...
	print("min_tot_time_powers_10_modulo:",min_tot_time)
	print("mean_tot_time_powers_10_modulo:",mean_tot_time)	
	print("max_tot_time_powers_10_modulo:",max_tot_time)
	#print("----------------------------------")	
