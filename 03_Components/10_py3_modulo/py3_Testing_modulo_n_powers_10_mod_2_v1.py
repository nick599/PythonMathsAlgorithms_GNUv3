...
def main():
	...
	test_range_100million = range(1,100000001)
	...
	for x in sample_range:	
		if x % 5 == 0:
			print("Test:",x)
		result = modulo_testing(test_range_100million,test_num)
		#return c_modulo_tot_time
		tot_time = tot_time + result
		time_values.append(result) 
	...
	print("min_tot_time_1_to_100million_modulo:",min_tot_time)
	print("mean_tot_time_1_to_100million_modulo:",mean_tot_time)
	print("max_tot_time_1_to_100million_modulo:",max_tot_time)
