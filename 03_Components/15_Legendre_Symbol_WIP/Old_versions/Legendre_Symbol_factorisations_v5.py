...
def leg_s_g_p_new(g,p):
	...
	if g==-1:
		...
		print("revised legendre_symbols to calculate after mod 4 rules:",leg_symbols)

		for leg_symbol in leg_symbols:
			leg_symbol[0] = leg_symbol[0] % leg_symbol[1]

		print("revised legendre_symbols to calculate after gcd:",leg_symbols)
