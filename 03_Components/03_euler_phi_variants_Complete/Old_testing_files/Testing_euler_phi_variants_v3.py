...
def euler_phi_noprimesused(n):	
	...
	for k in xrange(1, n + 1):		#O(n)	#Subtotal: O(n*pow(h,2))			
		if egcd(n, k) == 1:			#1 op for if. #O(pow(h,2)) for gcd
...
def euler_phi_primesused(n, primes):				
	...
	#	return a, status			#O(1)
		...
		factors = factorise(n)				#Worst: O(sqrt(size(n)))		
		#return factors
...
#		print "powers are: "+str(powers)
		#print "type of list powers is: "+str(type(powers))
...
#		raw_input("Waiting for user...")		
		...
		for prime in prime_factors:
			...
			number = prime_factors.index(prime)
#			print "number is: "+str(prime)
#			print "prime is: "+str(prime)
			#if not a:
			#print "number is: "+str(number)
			#print "power is: "+str(powers[number])
			#print "a currently is: "+str(a)
			if a == 0:			
				#print "powers[number] is: "+str(powers[number])
				a = pow(prime,powers[number]-1)
				#print "a is now: "+str(a)
			else:
				#print "powers[number] is: "+str(powers[number])
				a = a * pow(prime,powers[number]-1)
				#print "a is now: "+str(a)
