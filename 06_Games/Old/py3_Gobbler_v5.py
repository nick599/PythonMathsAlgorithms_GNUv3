...
print("Version:",version,". 24/06/2018.")
...
def main():
	...
	while Victory == False:
		...
		result2 = squares_available_to_move_to(piece_chosen, square_of_piece_chosen, board, colour_to_move)
		print("Squares available to move to:\n",result2)
		square_chosen = input("Please type the square to move ",piece_chosen," to ..\n")
...
def squares_available_to_move_to(piece_chosen, square_piece_chosen, board, colour_to_move, empty_squares):
	
	print("piece_chosen:\n", piece_chosen,"\nboard:\n", board,"\ncolour_to_move:\n", colour_to_move, empty_squares)
