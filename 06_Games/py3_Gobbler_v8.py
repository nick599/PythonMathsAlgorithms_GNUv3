...
print("Version:",version,". 07/07/2018.")
...
def main():
	...
	while Victory == False:
		...
		result2 = squares_available_to_move_to(piece_chosen, square_piece_chosen_col, square_piece_chosen_row, pieces_avail_off_board, board, colour_to_move)
...
def squares_available_to_move_to(piece_chosen, square_piece_chosen_col, square_piece_chosen_row, pieces_avail_off_board, board, colour_to_move):
