...
def main():
	...
	print('Running sieve ..')
	primes = sieve(sqrt_N, segment_size, limit)
	...
	csvfile_create(primes,filepath)

def sieve(sqrt_N, segment_size, limit):
	...
	while low <= limit:
		...
		sieve = xrange(low,low + segment_size + 1)
